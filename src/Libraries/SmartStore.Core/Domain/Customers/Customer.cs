...
namespace SmartStore.Core.Domain.Customers
{
	...
	public partial class Customer : BaseEntity, ISoftDeletable
    {
        ...
        private ICollection<PaymentRequest> _paymentRequests;
        ...
        /// Gets or sets customer generated content
        /// </summary>
        public virtual ICollection<PaymentRequest> PaymentRequests
        {
            get { return _paymentRequests ?? (_paymentRequests = new HashSet<PaymentRequest>()); }
            protected set { _paymentRequests = value; }
        }
        ...
        /// Gets or sets customer generated content
        /// </summary>
        public virtual ICollection<BankUpdateRequest> BankUpdateRequests
        {
            get { return _bankUpdateRequests ?? (_bankUpdateRequests = new HashSet<BankUpdateRequest>()); }
            protected set { _bankUpdateRequests = value; }
        }

        public virtual ICollection<CustomerPoints> CustomerPoints
        {
            get { return _customerPoints ?? (_customerPoints = new HashSet<CustomerPoints>()); }
            protected set { _customerPoints = value; }
        }

        public virtual ICollection<CustomerMembership> CustomerMemberships
        {
