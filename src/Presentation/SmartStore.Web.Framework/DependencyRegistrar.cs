...
namespace SmartStore.Web.Framework
{
	...
	public class CoreModule : Module
	{
		...
		protected override void Load(ContainerBuilder builder)
		{
            ...
            builder.RegisterType<PayTabsConfigService>().As<IPayTabsConfigService>().InstancePerRequest();
            builder.RegisterType<PaymentRequestService>().As<IPaymentRequestService>().InstancePerRequest();
            ...
            builder.RegisterType<MembershipPlanService>().As<IMembershipPlanService>().InstancePerRequest();
            builder.RegisterType<BankUpdateRequestService>().As<IBankUpdateRequestService>().InstancePerRequest();
        }
